...
public class QuanLyPhieuNhap extends javax.swing.JFrame {
    private PhieuNhapHangBUS phieunhapbus;
    private CTPhieuNhapBUS ctptBUS;
    private DefaultTableModel modelPhieuNhap = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        tfNgayNhapHang = new javax.swing.JTextField();
        ...
        tfMaPhieuNhap.setBackground(new java.awt.Color(27, 26, 67));
        tfMaPhieuNhap.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tfMaNhaCungCap.setBackground(new java.awt.Color(27, 26, 67));
        tfMaNhaCungCap.setForeground(new java.awt.Color(255, 255, 255));
        tfMaNhaCungCap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfMaNhaCungCapActionPerformed(evt);
            }
        });
        ...
        tfNgayNhapHang.setBackground(new java.awt.Color(27, 26, 67));
        tfNgayNhapHang.setForeground(new java.awt.Color(255, 255, 255));
        tfNgayNhapHang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNgayNhapHangActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tfMaPhieuNhap, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(tfMaNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btMaNhanVien))
                    .addComponent(tfNgayNhapHang, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btTaoMoi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(btThem, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btXoa, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfMaPhieuNhap, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(tfMaNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btMaNhanVien))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel5)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tfNgayNhapHang, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jLabel6))
        ...
        tbPhieuMuon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Phiếu Nhập", "Mã Nhân Viên", "Mhày Cung Cấp", "Ngày Nhập Hàng", "Tổng Tiền"
            }
        ));
        ...
        tfDonGia.setBackground(new java.awt.Color(27, 26, 67));
        tfDonGia.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tfDonGia, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(1, 1, 1)
                .addComponent(jLabel11)
        ...
        jPanel4.getAccessibleContext().setAccessibleName("Phiếu Nhập");
        jPanel4.getAccessibleContext().setAccessibleParent(btAll);
    ...
    private void tfMaNhaCungCapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfMaNhaCungCapActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfMaNhaCungCapActionPerformed

    private void tfNgayNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNgayNhapHangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNgayNhapHangActionPerformed
...
//        MaNVSel.setVisible(true);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        phieunhap.setMaPNH(tfMaPhieuNhap.getText());
        phieunhap.setNv(tfMaNhanVIen.getText());
        phieunhap.setNcc(tfMaNhaCungCap.getText());
        phieunhap.setNgayPH(tfNgayNhapHang.getText());
        ...
        tbPhieuMuon.setModel(modelPhieuNhap);
     ...
     private void Edit() {
        ...
        if (phieunhapbus.getList().size() > 0) {
            ...
            modelPhieuNhap.setValueAt(phieunhap.getMaPNH(), i, 0);
            modelPhieuNhap.setValueAt(phieunhap.getNv(), i, 1);
            modelPhieuNhap.setValueAt(phieunhap.getNcc(), i, 2);
            modelPhieuNhap.setValueAt(phieunhap.getNgayPH(), i, 3);
            modelPhieuNhap.setValueAt(phieunhap.getTongtien(), i, 4);

            tbPhieuMuon.setModel(modelPhieuNhap);
        }
        tfMaPhieuNhap.setEditable(true);
      ...
      private void Search() {
        ...
        String MaPhieuNhap, MaNhanVIen, MaNhaCungCap, NgayNhapHang ;
        int TongTien;

        MaPhieuNhap = tfMaPhieuNhap.getText();
        MaNhanVIen = tfMaNhanVIen.getText();
        MaNhaCungCap = tfMaNhaCungCap.getText();
        NgayNhapHang = tfNgayNhapHang.getText();
        TongTien =Integer.parseInt(tfTongTien.getText());

        ArrayList<PhieuNhapHangDTO> res = new ArrayList<PhieuNhapHangDTO>();
        try {
            res = phieunhapbus.Search(MaPhieuNhap, MaNhanVIen, MaNhaCungCap, NgayNhapHang, TongTien ,0);
        } catch (Exception ex) {
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        if (phieunhapbus.getList().size() > 0) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Chọn phiếu nhập ", "Chú ý!", JOptionPane.INFORMATION_MESSAGE);
                Logger.getLogger(QuanLyMuonTra.class.getName()).log(Level.SEVERE, null, ex);
            }
            modelPhieuNhap.removeRow(i);
            tbPhieuMuon.setModel(modelPhieuNhap);

            tfMaPhieuNhap.setText("");
            tfMaNhanVIen.setText("");
            tfMaNhaCungCap.setText("");
            tfNgayNhapHang.setText("");
            tfTongTien.setText("");
        }
    ...
    private void btThem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThem1ActionPerformed
        ...
        ctphieunhap.setPhieunhap(tfMaPN.getText());
        ctphieunhap.setSach(tfMaSach.getText());
        ctphieunhap.setSoluong(Integer.parseInt(tfSoLuong.getText()));
        ctphieunhap.setSach(tfMaSach.getText());
        ctphieunhap.setDongia(Integer.parseInt(tfDonGia.getText()));
        ctphieunhap.setThanhtien(Integer.parseInt(tfThanhTien.getText()));

        try {
            ctptBUS.Add(ctphieunhap);
        } catch (Exception ex) {
            Logger.getLogger(QuanLyMuonTra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void Searchct() {
        ...
        if (tfThanhTien.getText().equals("")) {
            ...
            ThanhTien = Integer.parseInt(tfSoLuong.getText());
        }

        ArrayList<CTPhieuNhapDTO> res = new ArrayList<CTPhieuNhapDTO>();
        try {
            res = ctptBUS.Search(MaPhieuNhap, MaSach, SoLuong,0,DonGia,0,ThanhTien,0);
        } catch (Exception ex) {
            Logger.getLogger(QuanLySach.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btXoa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoa1ActionPerformed
        ...
        if (ctptBUS.getList().size() > 0) {
            try {
                ctptBUS.Remove(ctptBUS.getList().get(i).getPhieunhap(),
                    ctptBUS.getList().get(i).getSach(),
                    ctptBUS.getList().get(i).getSoluong(),
                    ctptBUS.getList().get(i).getDongia(),
                    ctptBUS.getList().get(i).getThanhtien());
    ...
    private static javax.swing.JTextField tfMaNhaCungCap;
    private static javax.swing.JTextField tfMaNhanVIen;
    private static javax.swing.JTextField tfMaPN;
    private javax.swing.JTextField tfMaPhieuNhap;
    private static javax.swing.JTextField tfMaSach;
    private javax.swing.JTextField tfNgayNhapHang;
